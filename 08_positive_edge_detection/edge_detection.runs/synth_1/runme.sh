...
HD_PWD='C:/Users/Nicola/Documents/university/MSc_physics_of_data/S1_management_and_analysis_of_physics_dataset/lab_projects/08_positive_edge_detection/edge_detection.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_pos_ed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_pos_ed.tcl
