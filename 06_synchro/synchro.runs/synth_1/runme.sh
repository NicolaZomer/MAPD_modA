...
HD_PWD='C:/Users/Nicola/Documents/university/MSc_physics_of_data/S1_management_and_analysis_of_physics_dataset/lab_projects/06_synchro/synchro.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_synchro.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_synchro.tcl
