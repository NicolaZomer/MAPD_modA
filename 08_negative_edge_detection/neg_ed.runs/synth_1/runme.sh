...
HD_PWD='C:/Users/Nicola/Documents/university/MSc_physics_of_data/S1_management_and_analysis_of_physics_dataset/lab_projects/08_negative_edge_detection/neg_ed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neg_ed.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neg_ed.tcl
