...
synth_design -top tb_baud_gen -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef tb_baud_gen.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file tb_baud_gen_utilization_synth.rpt -pb tb_baud_gen_utilization_synth.pb"
