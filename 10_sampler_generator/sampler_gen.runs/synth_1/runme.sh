...
HD_PWD='C:/Users/Nicola/Documents/university/MSc_physics_of_data/S1_management_and_analysis_of_physics_dataset/lab_projects/10_sampler_generator/sampler_gen.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sampler_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sampler_gen.tcl
